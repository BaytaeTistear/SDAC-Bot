...
if (-not $SkipCommit) {
    ...
    Run-Step "Commit changes" {
        ...
        git add .github/dependabot.yml community_quotes.py database_backend.py server/community_quotes.py server/database_backend.py tests/test_account_notifications.py tests/test_dashboard_access.py tests/test_bot_startup.py tests/test_community_quotes.py tests/test_postgres_integration.py tests/test_quote_web.py

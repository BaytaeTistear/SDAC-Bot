...
$tag = "version-$Version"
$releaseAssets = @(
    " systemd/sdac-bot.service.template systemd/sdac-dashboard.service.template systemd/sdac-journald.conf nginx/sdac-dashboard.conf.template server/systemd/sdac-bot.service.template server/systemd/sdac-dashboard.service.template server/systemd/sdac-journald.conf server/nginx/sdac-dashboard.conf.template scripts/rollback_ubuntu.sh scripts/install_journal_limits.sh server/scripts/rollback_ubuntu.sh scripts/check_production.sh server/scripts/check_production.sh scripts/install_ubuntu.sh server/scripts/install_ubuntu.sh scripts/install_backup_prereqs.sh server/scripts/install_backup_prereqs.sh dist/Sana-Chan-Linux-Installer.sh",
...
if (-not $SkipCommit) {
    ...
    Run-Step "Commit changes" {
        git add RELEASE.md README.md HOSTING.md DOCKER.md .dockerignore .env.example Dockerfile docker-compose.yml systemd/sana-bot.service.template systemd/sana-dashboard.service.template systemd/sana-journald.conf requirements.txt database_migrations.py bot.py dashboard.py dashboard_account_templates.py dashboard_admin_roles.py dashboard_shell_assets.py dashboard_sidebar.py server/RELEASE.md server/README.md server/systemd/sana-bot.service.template server/systemd/sana-dashboard.service.template server/systemd/sana-journald.conf server/requirements.txt server/database_migrations.py server/bot.py server/dashboard.py server/dashboard_account_templates.py server/dashboard_admin_roles.py server/dashboard_shell_assets.py server/dashboard_sidebar.py scripts/pre_release_smoke.py scripts/release_readiness.py scripts/reset_admin_login.py scripts/dashboard_layout_check.py scripts/install_nginx_site.sh scripts/update_from_github.sh scripts/update_from_github_windows.ps1 nginx/sana-dashboard.conf.template server/scripts/pre_release_smoke.py server/scripts/release_readiness.py server/scripts/reset_admin_login.py server/scripts/dashboard_layout_check.py server/scripts/install_nginx_site.sh server/scripts/update_from_github.sh server/scripts/update_from_github_windows.ps1 server/nginx/sana-dashboard.conf.template tests/test_dashboard_sidebar_layout.py tests/test_backend_release_readiness.py tools/build_installers.ps1 tools/release_experimental.ps1 tools/release_official.ps1 apps/sdac-official-app/package.json apps/sdac-official-app/package-lock.json apps/sdac-official-app/src/main.ts apps/sdac-official-app/android/app/build.gradle  systemd/sdac-bot.service.template systemd/sdac-dashboard.service.template systemd/sdac-journald.conf nginx/sdac-dashboard.conf.template server/systemd/sdac-bot.service.template server/systemd/sdac-dashboard.service.template server/systemd/sdac-journald.conf server/nginx/sdac-dashboard.conf.template scripts/rollback_ubuntu.sh scripts/install_journal_limits.sh server/scripts/rollback_ubuntu.sh scripts/check_production.sh server/scripts/check_production.sh scripts/install_ubuntu.sh server/scripts/install_ubuntu.sh scripts/install_backup_prereqs.sh server/scripts/install_backup_prereqs.sh dist/Sana-Chan-Linux-Installer.sh dist/Sana-Chan-Ubuntu-Update.sh dist/Sana-Chan-Windows-Installer.exe dist/Sana-Chan-Windows-Update.ps1 dist/sana-update dist/sanachan-update

...
if (-not $SkipCommit) {
    ...
    Run-Step "Commit changes" {
        git add RELEASE.md README.md HOSTING.md DOCKER.md .dockerignore .env.example Dockerfile docker-compose.yml requirements.txt bot.py dashboard.py dashboard_account_templates.py dashboard_admin_roles.py dashboard_shell_assets.py dashboard_sidebar.py server/RELEASE.md server/README.md server/requirements.txt server/bot.py server/dashboard.py server/dashboard_account_templates.py server/dashboard_admin_roles.py server/dashboard_shell_assets.py server/dashboard_sidebar.py scripts/pre_release_smoke.py scripts/release_readiness.py scripts/dashboard_layout_check.py scripts/install_nginx_site.sh scripts/update_from_github.sh scripts/update_from_github_windows.ps1 scripts/windows/README.md scripts/windows/start_sana_local_server.ps1 nginx/sdac-dashboard.conf.template tests/test_dashboard_access.py tests/test_bot_startup.py tests/test_dashboard_sidebar_layout.py tests/test_backend_release_readiness.py server/scripts/pre_release_smoke.py server/scripts/release_readiness.py server/scripts/dashboard_layout_check.py server/scripts/install_nginx_site.sh server/scripts/update_from_github.sh server/scripts/update_from_github_windows.ps1 server/nginx/sdac-dashboard.conf.template tools/build_installers.ps1 tools/release_experimental.ps1 tools/release_official.ps1 apps/sdac-official-app/package.json apps/sdac-official-app/package-lock.json apps/sdac-official-app/src/main.ts dist/Sana-Chan-Linux-Installer.sh dist/Sana-Chan-Ubuntu-Update.sh dist/Sana-Chan-Windows-Installer.exe dist/Sana-Chan-Windows-Update.ps1 dist/sana-update dist/sanachan-update

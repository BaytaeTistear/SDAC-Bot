...
if (-not $SkipCommit) {
    ...
    Run-Step "Commit changes" {
        ...
        git add community_extensions.py server/community_extensions.py tests/test_quote_web.py tests/test_account_notifications.py tests/test_community_extensions.py

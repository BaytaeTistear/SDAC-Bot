...
UPSTREAM="${SANA_DASHBOARD_UPSTREAM:-${SDAC_DASHBOARD_UPSTREAM:-127.0.0.1:5000}}"
CLIENT_MAX_BODY_SIZE="${SANA_CLIENT_MAX_BODY_SIZE:-${SDAC_CLIENT_MAX_BODY_SIZE:-250M}}"
SITE_NAME="${SANA_NGINX_SITE_NAME:-${SDAC_NGINX_SITE_NAME:-sana-dashboard}}"
TEMPLATE="${SANA_NGINX_TEMPLATE:-${SDAC_NGINX_TEMPLATE:-$APP_DIR/nginx/sana-dashboard.conf.template}}"

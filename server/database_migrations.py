...
def migration_21_anime_profile_manga_sections(connection):
    ensure_column(connection, "anime_profiles", "manga_favorites", "TEXT")
...
def migration_24_quotes(connection):
    connection.execute("""

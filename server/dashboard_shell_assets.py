...
.sdac-sidebar-health { border: 1px solid var(--sdac-border); border-radius: 999px; box-sizing: border-box; color: var(--sdac-text) !important; display: inline-flex; flex: 0 0 auto; font-size: .78rem; font-weight: 850; justify-content: center; margin: 0 0 12px; max-width: 100%; padding: 6px 9px; text-decoration: none; width: 100%; }
.sdac-sidebar-health.ok { border-color: rgba(52, 211, 153, .55); color: #bbf7d0 !important; }
.sdac-sidebar-health.warn { border-color: rgba(245, 158, 11, .55); color: #fde68a !important; }
.sdac-sidebar-health.bad { border-color: rgba(251, 113, 133, .65); color: #fecdd3 !important; }
...
.sdac-sidebar-nav { align-items: stretch !important; display: flex !important; flex: 0 0 auto; flex-direction: column !important; flex-wrap: nowrap !important; gap: 10px !important; inline-size: 100% !important; margin: 0 !important; min-height: 0; overflow: visible; padding: 0; text-align: left !important; width: 100% !important; }
.sdac-sidebar-section { align-self: stretch !important; background: linear-gradient(180deg, rgba(17,24,43,.74), rgba(8,15,32,.78)); border: 1px solid var(--sdac-border); border-radius: 10px; display: block !important; flex: 0 0 auto; inline-size: 100% !important; margin: 0 !important; max-inline-size: 100% !important; min-height: 0; overflow: hidden; width: 100% !important; box-shadow: 0 14px 32px rgba(0,0,0,.22); }
.sdac-sidebar-main-section { display: block !important; width: 100% !important; }
.sdac-sidebar-section-title { align-items: center; background: linear-gradient(90deg, rgba(139,92,246,.20), rgba(24,217,255,.08)); color: var(--sdac-text); cursor: pointer; display: flex !important; font-size: .75rem; font-weight: 900; gap: 8px; inline-size: 100% !important; justify-content: space-between; letter-spacing: 0; line-height: 1.2; list-style: none; margin: 0 !important; min-height: 2.25rem; padding: 8px 10px; text-transform: uppercase; user-select: none; width: 100% !important; }
...
.sdac-sidebar-section-title span:first-child { flex: 1 1 auto; min-width: 0; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
.sdac-sidebar details, .sdac-sidebar summary { box-sizing: border-box !important; max-width: 100% !important; }

.sdac-sidebar-section-links { min-height: 0; overflow: visible; padding: 7px 6px 8px; width: 100% !important; }
.sdac-sidebar-link { border-radius: 7px; color: var(--sdac-text) !important; display: block !important; font-weight: 650; inline-size: 100% !important; line-height: 1.25; margin: 2px 0; max-inline-size: 100% !important; max-width: 100%; overflow-wrap: anywhere; padding: 9px 11px; text-align: left !important; text-decoration: none; white-space: normal; width: 100% !important; }
